  ...
  return (
    <section id="epp-camera-section" className="rounded-[2rem] border border-white/8 bg-white/5 p-5 shadow-glow backdrop-blur-xl">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        <div>
          ...
          <p className="mt-2 text-sm leading-6 text-steel-300">
            Modelo yolo26_epp detecta EPP directamente en cada frame capturado.
          </p>
        </div>
      ...
      <div className="mt-5 grid gap-4 xl:grid-cols-[minmax(0,1fr)_240px]">
        ...
        {/* Side panel: last annotated frame + detection list */}
        <div className="flex flex-col gap-4">
          {annotatedFrame && (
            <div className="rounded-[1.75rem] border border-white/8 bg-steel-900/70 overflow-hidden">
              <p className="px-4 pt-3 text-xs uppercase tracking-[0.25em] text-steel-400">Último frame anotado</p>
          ...
          {!annotatedFrame && !detections.length && isActive && (
